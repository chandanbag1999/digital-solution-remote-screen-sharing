...
const url = 'https://digitalsolution.in/';
      ...
      enhancementsTiles.insert(
          ...
          SettingsTile.switchTile(
              ...
              title: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(translate('Keep Digital Solution background service')),
          ...
          tiles: [
            ...
            SettingsTile(
              ...
              value: Padding(
                ...
                child: Text('Digital Solutions - Kolkata Apple Authorised Dealer')),
...
void showAbout(OverlayDialogManager dialogManager) {
  dialogManager.show((setState, close, context) {
    return CustomAlertDialog(
      title: Text(translate('About Digital Solution')),
        content: Wrap(direction: Axis.vertical, spacing: 12, children: [
        Text('Version: $version'),
        Text('Privacy Policy: Digital Solutions - Kolkata Apple Authorised Dealer'),
      ]),
      actions: [],
    );
